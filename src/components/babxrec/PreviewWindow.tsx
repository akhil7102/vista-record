...
export const PreviewWindow = ({ stream, isRecording }: PreviewWindowProps) => {
  ...
  return (
    <div className="flex-1 flex justify-center items-start px-2 py-1">
      <div className="relative w-full max-w-[74%] aspect-video bg-babxrec-preview border-2 border-babxrec-preview-border rounded-lg shadow-[var(--shadow-preview)] overflow-hidden">
        {stream ? (
          <>
            <video
              ref={videoRef}
